...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_6a5d73cc295123_66964948',
...
function content_6a5d73cc295123_66964948 (Smarty_Internal_Template $_smarty_tpl) {
?>
<div
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <p class="h2 modal-title"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Add to wishlist','d'=>'Modules.Blockwishlist.Shop'),$_smarty_tpl ) );?>
</p>
          <button
            type="button"
            class="btn-close"
...
"
        ...
        <div class="modal-footer">
          <div role="button" @click="openNewWishlistModal" class="wishlist-add-to-new text-primary-emphasis">
            <i class="material-icons text-primary-emphasis" aria-hidden="true">&#xE148;</i> <?php echo htmlspecialchars((string) ($_smarty_tpl->tpl_vars['newWishlistCTA']->value), ENT_QUOTES, 'UTF-8');?>
