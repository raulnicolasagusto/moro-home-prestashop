...
$catalogue = new MessageCatalogue('es-AR', array (
  ...
  array (
    ...
    'Delete all [1]categories[/1] before import' => 'Eliminar todos/as los/as [1]categorías[/1] antes de importar',
    ...
    'Set the resource permissions for this key:' => 'Seleccione los recursos que desea habilitar para esta clave:',
    ...
    'Weight' => 'Peso',
    'What do you want to import?' => '¿Qué querés importar?',
    'Xcache' => 'Xcache',
    ...
    'Your web browser:' => 'Tu navegador web:',
    'megabytes' => 'Megabytes',
    'minutes' => 'minutos',
    'seconds' => 'segundos',
  ),
...
Solo se permiten letras minúsculas, números y guiones.',
  ...
  array (
    ...
    'The limit chosen is larger than the server\'s maximum upload limit. Please increase the limits of your server.' => 'El límite elegido es mayor que el límite maximo de carga del servidor, Por favor, aumentar los límites de su servidor.',
    ...
    'You can\'t put this menu inside itself. ' => 'No puede poner ese menú en si-mismo',
...
Una vez actives la opción "%generate_rtl_label%", cualquier archivo específico RTL que hayas añadido al tema podría ser eliminado por la hoja de estilo creada.',
  ...
  array (
    ...
    'Apply to:' => 'Aplicar a:',
    'Are you sure you want to delete the selected item(s)?' => '¿Está seguro que desea borrar el (los) elemento(s) seleccionado(s)?',
  ...
  array (
    ...
    'Restoring your currency\'s default settings will delete all the customizations you made before. Parameters will look just the same as when the currency is freshly imported.' => 'Restaurar la configuración por defecto de tu moneda eliminará todas las personalizaciones que hayas hecho anteriormente. Los parámetros serán iguales a los que tenía la moneda cuando fue importada inicialmente.',
    'Search rate' => 'Buscar tasa',
  ...
  array (
    ...
    'Password is required.' => 'la contraseÃ±a es necesaria',
    ...
    'PrestaShop Fatal error: no utf-8 support. Please check your server configuration.' => 'PrestaShop error fatal: no hay soporte utf-8. Por favor compruebe la configuraciÃ³n de su servidor.',
    ...
    'Reduction value "%value%" is invalid. Allowed values from 0 to %max%' => 'El valor de descuento "%value%" es inválido. Los valores permitidos van de 0 a %max%',
...
Saludos',
  ...
  array (
    ...
    'Please mark each checkbox for the customer group(s), for which you want the payment module(s) to be available.' => 'Por favor, marca cada grupo de clientes para el cual quieres que esté disponible el(los) módulo(s) de pago.',
...
Gracias por su paciencia.',
  ...
  array (
    ...
    'e.g. 10:00AM - 9:30PM' => 'ej.: 10:00AM - 9:30PM',
  ),
  ...
  array (
    ...
    'Product(s) now available for download' => 'Producto(s) ahora disponible(s) para descargar',
  ...
  array (
    ...
    'Maintenance mode' => 'Modo mantenimiento',
    'One-page checkout' => 'Checkout En Una P&aacutegina',
  ),
  ...
  array (
    ...
    'In order for each message to have an impact, you need to know who it is being addressed to. ' => 'Para que cada mensaje tenga un impacto, usted necesita saber a quiÃ©n debe serdirigido.',
  ...
  array (
    ...
    'Next' => 'Siguiente',
    'Welcome' => 'Bienvenido',
    'Sell your first product quicker than you would have expected with our nice onboarding process.' => 'Venda su primer producto más rápido de lo que hubiera esperado, con nuestro amigable proceso de incorporación. ',
  ),
  ...
  array (
    ...
    'Carousel container' => 'Contenedor de carrusel ',
    'Change currency' => 'Moneda de cambio',
