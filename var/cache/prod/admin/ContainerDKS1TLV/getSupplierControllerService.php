...
class getSupplierControllerService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.7qVRPWR'] ?? $container->load('get_ServiceLocator_7qVRPWRService'))->withContext('PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\SupplierController', $container));
