...
final class Version20260413000001 extends AbstractMigration
{
    ...
    {
        return 'Insert default configuration values for PSE payment method';
    }
    public function up(Schema $schema): void
    {
        $defaults = ['MERCADOPAGO_PSE_ENABLED' => '0', 'MERCADOPAGO_PSE_DISCOUNT_PERCENT' => '0'];
    ...
    {
        $keys = ['MERCADOPAGO_PSE_ENABLED', 'MERCADOPAGO_PSE_DISCOUNT_PERCENT'];
