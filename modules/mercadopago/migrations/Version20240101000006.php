...
final class Version20240101000006 extends AbstractMigration
{
    ...
    {
        return 'Insert default configuration values for PIX payment method';
    }
    public function up(Schema $schema): void
    {
        $defaults = ['MERCADOPAGO_PIX_ENABLED' => '0', 'MERCADOPAGO_PIX_EXPIRATION' => '30', 'MERCADOPAGO_PIX_DISCOUNT' => '0'];
    ...
    {
        $keys = ['MERCADOPAGO_PIX_ENABLED', 'MERCADOPAGO_PIX_EXPIRATION', 'MERCADOPAGO_PIX_DISCOUNT'];
