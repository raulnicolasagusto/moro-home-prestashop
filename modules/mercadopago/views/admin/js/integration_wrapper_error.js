...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const original_component = document.querySelector("#integration-wrapper-error");
    ...
    const retryButton = integration_error_component_clone.querySelector('#integration-wrapper-error-btn');
    if (retryButton) {
